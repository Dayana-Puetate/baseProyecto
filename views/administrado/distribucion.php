...
<body>
 ...
 <table id="dg" class="easyui-datagrid" title="<center><bi><h2>PRODUCTOS POR BODEGA</h2></bi></center>"style="width:950px;height:250px"
        ...
        <thead>
            ...
            <th field="ID_BOD" width="60"><center>BODEGA</center></th>
    ...
    <div id="toolbar" style="height:40px">
        <div id="tb">
            ...
            <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search"  plain="true" onclick="doSearch()">BUSCAR BODEGA</a>
...
<!--VENTA-->
    <div id="dlgm" class="easyui-dialog" style="width:400px" data-options="closed:true,modal:true,border:'thin',buttons:'#dlgm-buttons'">
        <form id="ff" method="post" novalidate style="margin:0;padding:20px 50px" action="models/servicioProducto.php">
            <input type="hidden" id="op" name="op" value="distribuir">
            <div style="margin-bottom:10px">
                <input name="ID_PRO" class="easyui-textbox" required="true" label="Producto:" style="width:130%" data-options="editable:false">
            </div>
            <div style="margin-bottom:10px">
                <input name="ID_BOD" class="easyui-textbox" required="true" label="Bodega:" style="width:130%" >
            </div> 
            <div style="margin-bottom:10px">
